...
PL                  :   5.84  : Unitless,            Liver/ plasma PC; (In-house experiment) 
PK                  :   0.55  : Unitless,            Kidney/ plasma PC; (In-house experiment)
PLu                 :   0.51  : Unitless,            Lung/ plasma PC; (In-house experiment)
PF                  :   0.13  : Unitless,            Fat/ plasma PC; (Loccisano et al., 2012)
PRest               :   0.26  : Unitless,            Restofbody/ plasma PC; (Chou et al., 2019)
MW                  : 532.58  : g/mol,               6:2 Cl-PFESA molecular mass  
MKC                 : 0.0073  : Unitless,            Fraction mass of kidney (percent of BW); Brown, 1997
Free                : 0.005   : Unitless,            Free fraction; (In-house experiment)  
...
Vmax_apical_invitro :  1808   : pmol/mg protein/min, Vmax of apical transporter; averaged invitro value of Oatp1a1 (Weaver, 2010);Fitting by Chou and Lin (2019)
Km_apical           :  278    : mg/L,                Km of apical transpoter, in vitro value for Oatp1a1 (Weaver, 2010);Fitting by Chou and Lin (2019)
...
Kdif                :  5.1e-4 : L/h,                 Diffusion rate from proximal tubule cells to kidney serum; Fitting by Chou and Lin (2019)
Kabsc               :   0.25  : 1/(h*BW^-0.25),      Rate of absorption of 6:2 Cl-PFESA  from small intestine to liver; (In-house experiment)                         
KunabsC             :  1.2e-4 : 1/(h*BW^-0.25),      Rate of unabsorbed dose to appear in feces; (In-house experiment) 
...
KeffluxC            :   2.09  : 1/(h*BW^-0.25),      Rate of clearance of 6:2 Cl-PFESA  from proximal tubule cells into blood (initial value assumed the same as PFOA (2.49) from Worley and Fisher, 2015 and then re-fitting by Chou and Lin (2019))
KbileC              :  0.0026 : 1/(h*BW^-0.25),      Biliary elimination rate (male); liver to feces storage (initial value assumed the same as PFOA (0.004) from Worley and Fisher, 2015 and then re-fitting by Chou and Lin (2019))  
KurineC             :  1.6e-5 : 1/(h*BW^-0.25),      Rate of urine elimination from urine storage (male); (In-house experiment) 
HL                  :  4.1    : day,                 Half-Live of rats (Yi et al.,2022)
...
$CMT A_baso A_apical Adif Aefflux ACI AUCCA_free APTC AUCCPTC AFil AUCCfil Aurine ARest AUCCRest AST 
AabsST ASI AabsSI Afeces AL AUCCL ALu AF AVPlas_free AAPlas_free AUCCV_free AUCCK AUCCF Ameta AUCCLu AKb

$INIT @annotated
ADOSE:0.027: mg, Amount of input dose; assumed a virtual compartment for validating the model mass balance
...
double Rmeta = Eh*QL*CA*Free;                                                               // mg/h,   Rate of metabolism in liver compartment
dxdt_Ameta = Rmeta;                                                                         // mg,     Amount in metabolism
double RL = QL*(CA-CVL)*Free - Kbile*AL - Eh*QL*CA*Free + Kabs*ASI + K0*AST;                // mg/h,   Rate of change in liver compartment
